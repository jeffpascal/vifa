      ...
      <div className="col-md-6">
        ...
        <article>
          ...
          <p>
            ...
            Bistrita-Nasaud, Transilvania, Romania. Localitatea este asezata pe
            Valea Bistritei, intre Muntii Bargau si Muntii Calimani.
          </p>
          <p>
            Satul Colibita este asociat cu lacul de acumulare cu acelasi nume in
            jurul caruia s-a dezvoltat o frumoasa zona de agrement.
          </p>
          <p>
          ...
          <p>
            ...
            Bistrita, prin Pasul Tihuta, de Vatra Dornei. In Prundul Bargaului,
            in mijlocul localitatii, exista o intersectie ce duce spre Bistrita
            Bargaului, apoi spre Colibita.
          </p>
        </article>
        ...
        <article>
          ...
          <p>
            ...
            aerul din Alpii elvetieni. <br></br>Aerul este benefic pentru cei cu
            probleme respiratorii dar are si un efect antistress si
            antidepresiv.
          </p>

          <p>
            Documentele vremii spun ca la finele secolului XIX, o domnişoară din
            Bistriţa s-a vindecat de tuberculoză graţie aerului din această
            zonă, extrem de bogat în ozon. Un anume Hans Lewi, din Bistriţa,
            şi-a trimis fata bolnavă de tuberculoză la Colibiţa, pentru odihnă
            şi refacere. După trei luni, fata s-a însănătoşit.
          </p>
      ...
      <div className="col-md-6">
        <article>
          ...
          <p>
            ...
            vacanta, pentru o luna de miere sau doar pentru un weekend, in orice
            anotimp.
          </p>
