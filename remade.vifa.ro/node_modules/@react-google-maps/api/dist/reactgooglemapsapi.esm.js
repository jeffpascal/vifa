import { createContext, useContext, createElement, Fragment, PureComponent, createRef, useRef, useState, useEffect, memo, Children, isValidElement, cloneElement, Component } from 'react';
...
function (_React$PureComponent) {
  ...
  function OverlayView(props) {
    ...
    _this.onAdd = function () {
      ...
      !!!_this.props.mapPaneName ? process.env.NODE_ENV !== "production" ? invariant(false, "OverlayView requires props.mapPaneName but got %s", _this.props.mapPaneName) : invariant(false) : void 0; // https://developers.google.com/maps/documentation/javascript/3.exp/reference#MapPanes
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  _proto.render = function render() {
    return this.mapPaneEl ? createPortal(createElement("div", {
      ref: this.containerRef,
      style: _extends({}, this.state.containerStyle, {
        position: 'absolute'
      })
    }, createElement(ContentMountHandler, {
      onLoad: this.setOverlayViewCallback
    }, Children.only(this.props.children))), this.mapPaneEl) : createElement(Fragment, null);
  };
