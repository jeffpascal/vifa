const data = [
    {
        ...
        descriere: 
            {
                card: "<h1>sale</h1>Vila Franceza este situată pe malul nordic al lacului Colibița, într-o poziție care asigură o perspectivă unică asupra lacului dar și a munților Călimani.",
                page: "<h1>sale</h1>normal"
            },
        camere: [
            {
